...
function DocumentConversion(options, comments) {
    ...
    // The toggles for the additional style preservation mechanisms
    var _stylePreservations = options.stylePreservations || {};

    if (_stylePreservations === 'default' || _stylePreservations === 'all') {
        _stylePreservations = {useColorSpans: true, useFontSizeSpans: true};
    }

    if (typeof _stylePreservations !== 'object')  {
        _stylePreservations = {};
    }
    ...
    function convertRun(run, messages, options) {
        ...
        if (_stylePreservations.useFontSizeSpans && run.fontSize) {
            paths.push(htmlPaths.element('span', {style: 'font-size:' + run.fontSize + 'px'}, {fresh: false}));
        }
