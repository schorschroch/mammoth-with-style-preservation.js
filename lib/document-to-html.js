...
function DocumentConversion(options, comments) {
    ...
    function convertTable(element, messages, options) {
        ...
        if (_stylePreservations.applyTableCellStyles) {
            if (htmlPath._elements && htmlPath._elements.length > 0) {
                htmlPath._elements[0].attributes.style = 'border-collapse: collapse;';  // always include this one
                if (element.preservedStyles) {
                    htmlPath._elements[0].attributes.style += preserverUtils.convertPreservableStylesToCssString(element.preservedStyles);
                }
            }
        }
    ...
    function convertTableCell(element, messages, options) {
        ...
        if (_stylePreservations.applyTableCellStyles && element.preservedStyles) {
            attributes.style = preserverUtils.convertPreservableStylesToCssString(element.preservedStyles);
        }
