...
function main(argv) {
    ...
    var stylePreservations = argv.style_preservations;
    var omml2mathml = argv.omml2mathml;
    
    readStyleMap(styleMapPath).then(function(styleMap) {
        var options = {
            styleMap: styleMap,
            outputFormat: outputFormat,
            stylePreservations: stylePreservations || 'special',
            omml2mathml: omml2mathml || 'false'
        };
